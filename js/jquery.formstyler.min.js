...
(function(c){c.fn.styler=function(h){h=c.extend({wrapper:"form",idSuffix:"-styler",filePlaceholder:"Aucun fichier s̩lectionn̩",fileBrowse:"Revoir ...",selectSearch:!0,selectSearchLimit:10,selectSearchNotFound:"Aucun r̩sultat",selectSearchPlaceholder:"Recherche ...",selectVisibleOptions:0,singleSelectzIndex:"1",
...
20&&k()):(e.height("auto").css({top:"auto",bottom:A}),k=function(){n.css("max-height",Math.floor((g-b.scrollTop()-20-u)/l)*l)},k(),n.css("max-height",r),"none"!=y&&n.css("max-height",y),g-b.scrollTop()-20<e.outerHeight()+20&&k())}c("div.jqselect").css({zIndex:"2"}).removeClass("opened focused");d.css({zIndex:"2"});e.is(":hidden")?(c("div.jq-selectbox__dropdown:visible").hide(),e.show(),d.addClass("opened")):(e.hide(),d.removeClass("opened"));f.filter(".selected").length&&
